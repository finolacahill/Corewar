...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/12/10 14:55:38 by adietric          #+#    #+#             */
/*   Updated: 2019/12/11 18:14:17 by adietric         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../../includes/vm.h"

int				do_op_or(t_all *all, t_op *op, uint8_t *content)
{
	return(0);
