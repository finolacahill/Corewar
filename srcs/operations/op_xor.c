...
uint16_t		check_op_xor(t_all *all, uint8_t *content)
{
	...
	i += content[1] == 100 ? 2 * 1 + op_check_tab[7].dir_size : 0;
	i += content[1] == 116 ? 2 * 1 + IND_SIZE : 0;
	i += content[1] == 148 ? 2 * 1 + op_check_tab[7].dir_size : 0;
	i += content[1] == 164 ? 1 + 2 * op_check_tab[7].dir_size : 0;
	i += content[1] == 180 ? 1 + IND_SIZE + op_check_tab[7].dir_size : 0;
	i += content[1] == 212 ? 2 * 1 + IND_SIZE : 0;
	i += content[1] == 228 ? 1 + IND_SIZE + op_check_tab[7].dir_size : 0;
