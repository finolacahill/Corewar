...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/12/10 14:52:27 by adietric          #+#    #+#             */
/*   Updated: 2019/12/11 18:13:07 by adietric         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../../includes/vm.h"

int				do_op_and(t_all *all, t_op *op, uint8_t *content)
{
	return(0);
